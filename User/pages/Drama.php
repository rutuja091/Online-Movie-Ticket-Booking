...
$sql = "SELECT * FROM movies WHERE category='Drama' ORDER BY id DESC ";
...
?>
        ...
        <!-- <div class="movie-card">
            <img src="./../../Images/Movies/hamlet.jpg" alt="Movie 2">
            <div class="card-content">
                <h3> Hamlet</h3>
                <p>Hamlet, such a tortured soul who is obsessed with vengeance for believing that his Uncle murdered Hamlet's.
            </p>
        ...
        <div class="movie-card">
            <img src="./../../Images/Movies/oneday.jpg" alt="Movie 2">
            <div class="card-content">
                <h3>One Day</h3>
                <p>It was so well done and the acting is quite impressive. For those lamenting that this was an unnecessary remake .
                </p>
